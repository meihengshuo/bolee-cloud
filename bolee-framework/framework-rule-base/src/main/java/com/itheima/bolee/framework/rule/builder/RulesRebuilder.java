 ...
 * the License.
 ******************************************************************************/
package com.itheima.bolee.framework.rule.builder;

import com.itheima.bolee.framework.rule.RuleException;
import com.itheima.bolee.framework.rule.action.Action;
import com.itheima.bolee.framework.rule.action.ConsolePrintAction;
import com.itheima.bolee.framework.rule.action.ExecuteMethodAction;
import com.itheima.bolee.framework.rule.action.VariableAssignAction;
import com.itheima.bolee.framework.rule.model.flow.Connection;
import com.itheima.bolee.framework.rule.model.flow.DecisionItem;
import com.itheima.bolee.framework.rule.model.library.Datatype;
import com.itheima.bolee.framework.rule.model.library.ResourceLibrary;
import com.itheima.bolee.framework.rule.model.library.action.ActionLibrary;
import com.itheima.bolee.framework.rule.model.library.action.Method;
import com.itheima.bolee.framework.rule.model.library.action.SpringBean;
import com.itheima.bolee.framework.rule.model.library.constant.ConstantCategory;
import com.itheima.bolee.framework.rule.model.library.variable.Variable;
import com.itheima.bolee.framework.rule.model.library.variable.VariableCategory;
import com.itheima.bolee.framework.rule.model.rule.*;
import com.itheima.bolee.framework.rule.model.rule.lhs.*;
import com.itheima.bolee.framework.rule.model.rule.loop.LoopEnd;
import com.itheima.bolee.framework.rule.model.rule.loop.LoopRule;
import com.itheima.bolee.framework.rule.model.rule.loop.LoopStart;
import com.itheima.bolee.framework.rule.model.rule.loop.LoopTarget;
...
public class RulesRebuilder {
	...
	private void rebuildParameters(ResourceLibrary resLibraries,List<Parameter> parameters,List<com.itheima.bolee.framework.rule.model.library.action.Parameter> targetParameters,Map<String,String> namedMap,boolean forDSL) {
		if(parameters!=null && targetParameters!=null){
			for(int i=0;i<parameters.size();i++){
				...
				com.itheima.bolee.framework.rule.model.library.action.Parameter p=targetParameters.get(i);
	 ...
	 public void rebuildValue(Value value,ResourceLibrary resLibraries,Map<String,String> namedMap,boolean forDSL){
		...
		if(value instanceof ParenValue){
			...
			if(forDSL){
				...
				com.itheima.bolee.framework.rule.model.library.constant.Constant constant=getConstantByLabel(resLibraries.getConstantCategories(), category, label);
				cv.setConstantName(constant.getName());				
			}else{
				String name=cv.getConstantName();
				com.itheima.bolee.framework.rule.model.library.constant.Constant constant=getConstantByName(resLibraries.getConstantCategories(), category, name);
	...
	private com.itheima.bolee.framework.rule.model.library.constant.Constant getConstantByName(List<ConstantCategory> constantCategories,String category,String name){
		for(ConstantCategory c:constantCategories){
			if(!c.getLabel().equals(category)){
				continue;
			}
			for(com.itheima.bolee.framework.rule.model.library.constant.Constant constant:c.getConstants()){
	...
	private com.itheima.bolee.framework.rule.model.library.constant.Constant getConstantByLabel(List<ConstantCategory> constantCategories,String category,String label){
		for(ConstantCategory c:constantCategories){
			if(!c.getLabel().equals(category)){
				continue;
			}
