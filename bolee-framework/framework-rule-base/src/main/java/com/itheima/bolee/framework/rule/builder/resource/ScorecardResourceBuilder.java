 ...
 * the License.
 ******************************************************************************/
package com.itheima.bolee.framework.rule.builder.resource;

import com.itheima.bolee.framework.rule.RuleException;
import com.itheima.bolee.framework.rule.action.Action;
import com.itheima.bolee.framework.rule.action.ScoringAction;
import com.itheima.bolee.framework.rule.builder.KnowledgeBase;
import com.itheima.bolee.framework.rule.builder.ResourceLibraryBuilder;
import com.itheima.bolee.framework.rule.builder.RulesRebuilder;
...
import com.itheima.bolee.framework.rule.model.rule.Rhs;
import com.itheima.bolee.framework.rule.model.rule.Rule;
import com.itheima.bolee.framework.rule.model.rule.lhs.*;
import com.itheima.bolee.framework.rule.model.scorecard.*;
import com.itheima.bolee.framework.rule.model.scorecard.runtime.ScoreRule;
import com.itheima.bolee.framework.rule.model.scorecard.runtime.ScoreRuntimeValue;
import com.itheima.bolee.framework.rule.model.table.Condition;
