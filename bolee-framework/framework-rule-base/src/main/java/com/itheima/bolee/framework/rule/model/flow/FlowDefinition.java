 ...
 * the License.
 ******************************************************************************/
package com.itheima.bolee.framework.rule.model.flow;
...
import com.itheima.bolee.framework.rule.model.flow.ins.FlowInstance;
...
import com.itheima.bolee.framework.rule.runtime.event.impl.ProcessBeforeCompletedEventImpl;
import com.itheima.bolee.framework.rule.runtime.event.impl.ProcessBeforeStartedEventImpl;
...
public class FlowDefinition implements ProcessDefinition {
	...
	@JsonDeserialize(using=com.itheima.bolee.framework.rule.model.flow.FlowNodeJsonDeserializer.class)
