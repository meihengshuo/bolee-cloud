...
//			inputStream=applicationContext.getResource("classpath:com/itheima/bolee/framework/rule/console/repository/workspace_template.xml").getInputStream();
//			inputStream=applicationContext.getResource("classpath:com/itheima/bolee/rule/config/workspace_template.xml").getInputStream();
...
//		String xml="classpath:com/itheima/bolee/rule/console/repository/database/configs/"+RepositoryBuilder.databaseType+".xml";
//		String xml="classpath:com/itheima/bolee/rule/config/"+RepositoryBuilder.databaseType+".xml";
